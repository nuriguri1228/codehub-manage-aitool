...
export const mockUsageLogs: UsageLog[] = [
  ...
  { id: 'log-003', userId: 'user-002', userName: '이프론트', aiToolName: 'GitHub Copilot', tokensUsed: 8000, cost: 80, timestamp: '2024-12-10T13:30:00Z' },
  ...
  { id: 'log-006', userId: 'user-002', userName: '이프론트', aiToolName: 'GitHub Copilot', tokensUsed: 5000, cost: 50, timestamp: '2024-12-09T15:00:00Z' },
  ...
  { id: 'log-009', userId: 'user-002', userName: '이프론트', aiToolName: 'GitHub Copilot', tokensUsed: 11000, cost: 110, timestamp: '2024-12-08T09:00:00Z' },
...
export const mockToolDistribution: ToolDistribution[] = [
  ...
  { toolName: 'GitHub Copilot', count: 3, color: '#22c55e' },
...
export const mockMonthlyTrends: MonthlyTrend[] = [
  { month: '2024-07', 'Claude Code': 1, 'GitHub Copilot': 1, 'Cursor AI': 0 },
  { month: '2024-08', 'Claude Code': 2, 'GitHub Copilot': 1, 'Cursor AI': 0 },
  { month: '2024-09', 'Claude Code': 3, 'GitHub Copilot': 2, 'Cursor AI': 0 },
  { month: '2024-10', 'Claude Code': 4, 'GitHub Copilot': 2, 'Cursor AI': 1 },
  { month: '2024-11', 'Claude Code': 5, 'GitHub Copilot': 3, 'Cursor AI': 2 },
  { month: '2024-12', 'Claude Code': 7, 'GitHub Copilot': 3, 'Cursor AI': 3 },
];
